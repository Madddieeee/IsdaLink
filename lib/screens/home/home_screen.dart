...
class HomeScreen extends StatelessWidget {
  ...
  void openHomeSearch(BuildContext context, {String initialQuery = ''}) {
    showModalBottomSheet<void>(
      ...
      builder: (sheetContext) {
        return HomeSearchSheet(
          ...
          onSupplierTap: (supplier, supplierId) {
            openSupplierDetails(context, supplier, supplierId: supplierId);
          },
          onProductTap: (supplier, product, stockId, supplierId) {
            openProductDetails(
              context,
              supplier,
              product,
  ...
  void openMyOrders(BuildContext context) {
    Navigator.push(
      context,
  ...
  void openLatestFishStocks(BuildContext context) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => const LatestFishStocksScreen()),
    );
  }

  void openMe(BuildContext context) {
    Navigator.push(
      context,
  ...
  Widget recommendedSuppliersList(BuildContext context) {
    return SizedBox(
      height: 162,
            ...
            builder: (context, stockSnapshot) {
              ...
              if (stockSnapshot.hasData) {
                ...
                for (final stock in availableStocks) {
                  final supplierId = (stock.data()['supplierId'] ?? '')
                      .toString()
                      .trim();
              ...
              final List<Widget> cards = approvedSuppliers.map<Widget>((
                document,
              ) {
                final data = document.data();
              ...
              if (allApprovedSuppliers.length > approvedSuppliers.length) {
                cards.add(
  ...
  Widget todayOverview(BuildContext context) {
            ...
            child: OverviewCountCard(
              ...
              countBuilder: (docs) {
                return docs.where((doc) {
                  ...
                  final quantity =
                      double.tryParse((data['quantity'] ?? 0).toString()) ?? 0;
                ...
                children: [
                  Stack(
                    children: [
                      ...
                      Padding(
                        padding: EdgeInsets.only(top: homeHeaderHeight - 26),
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              HomeMarketShowcase(
                                onBrowseSuppliers: () =>
                                    openBrowseSuppliers(context),
                                onBrowseFishStocks: () =>
                                    openLatestFishStocks(context),
                              ),
                              ...
                              RecentFishPosts(
                                ...
                                onProductTap:
                                    (supplier, product, stockId, supplierId) {
                                      openProductDetails(
                                        context,
                                        supplier,
                                        product,
      ...
      children: [
        ...
        Positioned(
          ...
          child: const AnnotatedRegion<SystemUiOverlayStyle>(
            ...
            child: IgnorePointer(child: ColoredBox(color: Color(0xFF06355F))),
          ),
        ),
        Positioned(
...
class _PinnedHeaderCircleButton extends StatelessWidget {
  const _PinnedHeaderCircleButton({required this.icon, required this.onTap});
  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      shape: const CircleBorder(side: BorderSide(color: Color(0xFFCDE7F0))),
      child: InkWell(
        onTap: onTap,
        ...
        child: SizedBox(
          width: 38,
          height: 38,
          child: Icon(icon, color: const Color(0xFF075C9B), size: 19),
        ),
      ),
    );
  }
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: const Row(
            ...
            children: [
              Icon(Icons.search_rounded, color: Color(0xFF075C9B), size: 18),
              SizedBox(width: 6),
              Text(
                'Search',
                style: TextStyle(
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
      ...
      builder: (context, snapshot) {
        ...
        return StaticOverviewCard(title: title, value: value, icon: icon);
      },
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: const Color(0xFFE0F1F7)),
        boxShadow: const [
          BoxShadow(
      ...
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Icon(icon, color: const Color(0xFF087AC0), size: 19),
          const SizedBox(height: 5),
          Text(
            value,
            maxLines: 1,
              ...
              builder: (context, notificationSnapshot) {
                ...
                return HomeBottomNav(
                  ...
                  supplierNotificationCount:
                      supplierPendingCount + stockNotificationCount,
                  onMyOrders: onMyOrders,
                  onAnalytics: onAnalytics,
                  onMe: onMe,
                );
...
enum HomeSearchFilter { all, fish, suppliers, locations }
...
class HomeSearchSheet extends StatefulWidget {
  ...
  final void Function(Supplier supplier, String supplierId) onSupplierTap;
...
class _HomeSearchSheetState extends State<HomeSearchSheet> {
  ...
  List<String> fishSearchValues(
    ...
    return switch (selectedFilter) {
      ...
      HomeSearchFilter.locations => <String>[location],
  ...
  List<String> supplierSearchValues(
    ...
    final data = document.data();
    final supplier = supplierService.supplierFromProfile(data);
    final serviceArea = supplierService.firstAvailableText(data, const [
      'serviceArea',
      'primaryMarketArea',
    ]);
    final ownerName = supplierService.firstAvailableText(data, const [
      'ownerName',
      'fullName',
    ]);
    ...
    return switch (selectedFilter) {
      ...
      HomeSearchFilter.locations => <String>[supplier.location, serviceArea],
  ...
  bool fishMatches(QueryDocumentSnapshot<Map<String, dynamic>> document) {
  ...
  bool supplierMatches(QueryDocumentSnapshot<Map<String, dynamic>> document) {
  ...
  int compareFishDocuments(
    ...
    if (normalizedQuery.isNotEmpty) {
      final scoreComparison = relevanceScore(
        fishSearchValues(first),
  ...
  String cleanPriceUnit(String value, String fallback) {
  ...
  String fishLocation(Map<String, dynamic> data, Supplier supplier) {
    ...
    return cleanText(value: supplier.location, fallback: 'Caraga Region');
  }
  ...
  List<String> suggestedSearchTerms({
    ...
    }).toList()..sort(compareFishDocuments);
  ...
  Future<void> toggleFavoriteSupplier({
    ...
    try {
      ...
      final message = AppErrorMessage.from(
        error,
        fallback:
            'Favorite suppliers could not be updated right now. Please try again.',
  ...
  Widget resultSummary({required int resultCount}) {
    ...
    if (searchText.isNotEmpty) {
      label =
          '$resultCount match${resultCount == 1 ? '' : 'es'} for "$searchText"';
    } else {
        ...
        children: [
          ...
          if (searchText.isNotEmpty)
            TextButton(
              ...
              child: const Text(
                'Clear',
                style: TextStyle(fontSize: 9.8, fontWeight: FontWeight.w900),
              ),
            ),
        ],
      ),
  ...
  Widget buildResults({
    ...
    final listingCounts = availableListingCounts(fishDocuments);
    ...
    return ListView(
      ...
      children: [
        ...
        resultSummary(resultCount: totalResultCount),
        if (visibleFish.isNotEmpty) ...[
          ...
          ...visibleFish.map((document) {
            ...
            return HomeSearchFishCard(
              ...
              location: fishLocation(data, supplier),
              priceText:
              ...
              builder: (context, favoriteSnapshot) {
                ...
                return HomeSearchSupplierCard(
                  ...
                  onTap: () {
                    ...
                    Future.microtask(
                      () => widget.onSupplierTap(supplier, document.id),
                    );
                  },
                );
              },
        ...
        return Container(
          ...
          child: Column(
            children: [
              ...
              const Divider(height: 1, thickness: 1, color: Color(0xFFE2EEF4)),
              Expanded(
                child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                  stream: fishStream,
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              Icon(
                icon,
                color: selected ? Colors.white : const Color(0xFF6D8495),
                size: 15,
              ),
          ...
          Row(
            children: [
              ...
              TextButton(
                ...
                child: const Text(
                  'Clear all',
                  style: TextStyle(fontSize: 8.4, fontWeight: FontWeight.w900),
                ),
              ),
            ],
          ),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          ...
          colors: [Color(0xFFEAF8FC), Color(0xFFF3FAFF)],
        ),
        borderRadius: BorderRadius.circular(18),
        border: Border.all(color: const Color(0xFFD7EBF3)),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Row(
            children: [
              Icon(icon, color: const Color(0xFF087AC0), size: 15),
              const SizedBox(width: 5),
              Expanded(
                child: Text(
                  title,
              ...
              return Material(
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(99),
                      border: Border.all(color: const Color(0xFFD9E9F1)),
                    ),
                    child: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
...
class HomeSearchFishCard extends StatelessWidget {
    ...
    if (!hasSupplierImage) {
      return Container(
        ...
        decoration: BoxDecoration(
          color: const Color(0xFFEAF7FB),
          shape: BoxShape.circle,
          border: Border.all(color: const Color(0xFFD4EAF4)),
        ),
        child: const Icon(
          Icons.storefront_rounded,
          color: Color(0xFF087AC0),
  ...
  Widget image() {
    if (!hasImage) {
      return const _SearchImagePlaceholder(icon: Icons.set_meal_rounded);
    }
...
class HomeSearchSupplierCard extends StatelessWidget {
  ...
  Widget image() {
    if (!hasImage) {
      return const _SearchImagePlaceholder(icon: Icons.storefront_rounded);
    }
            ...
            child: Row(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: const LinearGradient(
                      colors: [Color(0xFF0D8DD3), Color(0xFF12B6D6)],
                    ),
...
class _SearchImagePlaceholder extends StatelessWidget {
  const _SearchImagePlaceholder({required this.icon, this.loading = false});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: loading
          ...
          : Icon(icon, color: const Color(0xFF087AC0), size: 27),
    );
  }
}

class _SearchOwnerBadge extends StatelessWidget {
  const _SearchOwnerBadge({required this.label});
...
class HomeSearchBrowseHint extends StatelessWidget {
  const HomeSearchBrowseHint({super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: const Row(
        children: [
          Icon(Icons.search_rounded, color: Color(0xFF087AC0), size: 18),
          SizedBox(width: 8),
          Expanded(
            child: Text(
        ...
        Container(
          ...
          decoration: BoxDecoration(
            gradient: const LinearGradient(
              ...
              colors: [Color(0xFFE6F7FC), Color(0xFFF3F9FF)],
            ),
            borderRadius: BorderRadius.circular(22),
              ...
              if (query.trim().isNotEmpty) ...[
                ...
                OutlinedButton.icon(
                  ...
                  style: OutlinedButton.styleFrom(
                    foregroundColor: const Color(0xFF087AC0),
                    side: const BorderSide(color: Color(0xFFB9DCEB)),
...
class HomeSearchErrorState extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final message = AppErrorMessage.from(
      error,
      fallback:
          'Marketplace search could not be loaded right now. Please try again in a moment.',
    );
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            color: Colors.white,
            borderRadius: BorderRadius.circular(22),
            border: Border.all(color: const Color(0xFFF0D6D4)),
          ),
          child: Column(
            children: [
              Container(
