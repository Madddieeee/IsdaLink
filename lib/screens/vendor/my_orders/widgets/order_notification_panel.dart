...
class OrderNotificationPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
      stream: service.notificationsStream(vendorId),
      builder: (context, snapshot) {
        ...
        final notificationsToShow = unreadNotifications.take(3).toList();
            ...
            children: [
              Row(
                children: [
                  ...
                  TextButton(
                    onPressed: () =>
                        service.markNotificationsRead(unreadNotifications),
                    child: const Text(
                      'Mark as read',
                      style: TextStyle(
                        fontSize: 9.5,
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(
                        ...
                        color: OrderHelpers.statusColor(status),
                        size: 20,
                      ),
                      const SizedBox(width: 8),
                      Expanded(
